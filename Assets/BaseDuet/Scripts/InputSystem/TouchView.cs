namespace BaseDuet.Scripts.InputSystem
{
    ...
    public class TouchView : MonoBehaviour, IDragMultiple
    {
        ...
        public void OnBeginDrag(Vector3 worldPosition) { this.TargetView.OnBeginDrag(worldPosition); }
        public void OnDrag(Vector3      worldPosition) { this.TargetView.OnDrag(worldPosition); }
        public void OnEndDrag(Vector3   worldPosition) { this.TargetView.OnEndDrag(worldPosition); }
        public void DragSucceed()                      { this.TargetView.DragSucceed(); }
