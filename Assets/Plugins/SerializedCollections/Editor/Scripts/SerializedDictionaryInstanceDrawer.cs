...
namespace AYellowpaper.SerializedCollections.Editor
{
    public class SerializedDictionaryInstanceDrawer
    {
        ...
        private void OnDrawElement(Rect rect, int index, bool isActive, bool isFocused)
        {
            ...
            bool isReadOnlyKey = _dictionaryAttribute == null ? false : _dictionaryAttribute.IsReadOnlyKey;
            DrawGroupedElement(keyRect, 20, keyProperty, keyDisplayData.EffectiveDisplayType, isReadOnlyKey);
        ...
        private void DrawGroupedElement(Rect rect, int spaceForProperty, SerializedProperty property, DisplayType displayType, bool isReadOnly = false)
        {
