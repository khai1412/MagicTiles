using System.Collections.Generic;
    ...
    public class NoteData {
		...
		{
        return string.Format("[NoteData]" +
            " indexTrack: " + indexTrack +
            " noteOrder: " + noteOrder +
            " timeAppear: " + timeAppear +
            " timeAppearScaleApplied: " + timeAppearScaleApplied +
            " duration: " + duration +
            " durationScaleApplied: " + durationScaleApplied +
            " noteEvent: " + noteEvent +
            " speedBegin: " + speedBegin +
            " type: " + type +
            " nodeID: " + nodeID +
            " stringIndex: " + laneIndex +
            " timeKeepSong: " + timeKeepSong); 
